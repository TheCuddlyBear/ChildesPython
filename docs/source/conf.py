...
from childespython import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "childespython"
...
html_title = f"childespython v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/TheCuddlyBear/ChildesPython",
            "html": """
